...
const Tag = ({ tag, blogs, query }) => {
    const head = () => (
        <Head>
            ...
            <meta name="description" content={`Electronics Programming tutorials on ${tag.name}`} />
            <link rel="canonical" href={`${DOMAIN}/categories/${query.slug}`} />
            <meta property="og:title" content={`${tag.name}| ${APP_NAME}`} />
            <meta property="og:description" content={`Electronics Programming tutorials on ${tag.name}`} />
