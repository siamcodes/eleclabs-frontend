...
const Category = ({ category, blogs, query }) => {
    const head = () => (
        <Head>
            ...
            <meta name="description" content={`Electronics Programming tutorials on ${category.name}`} />
            <link rel="canonical" href={`${DOMAIN}/categories/${query.slug}`} />
            <meta property="og:title" content={`${category.name}| ${APP_NAME}`} />
            <meta property="og:description" content={`Electronics Programming tutorials on ${category.name}`} />
